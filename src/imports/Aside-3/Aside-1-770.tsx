import svgPaths from "./svg-hu3u81aj1k";
import { imgGroup, imgGroup1, imgGroup2 } from "./svg-swvho";
...
function Frame10() {
  return (
    <div className="bg-[rgba(13,34,59,0.05)] content-stretch flex flex-col items-center justify-center px-[16px] py-[12px] relative rounded-bl-[20px] rounded-tl-[20px] rounded-tr-[20px] shrink-0 w-[323px]">
      <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[0] not-italic relative shrink-0 text-[#374151] text-[0px] w-full">
        <span className="leading-[24px] text-[16px]">{`Hey! I want to check a flight status `}</span>
        <span className="font-['Etihad_Altis:Bold',sans-serif] leading-[24px] text-[16px]">EY63</span>
      </p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Frame">
      <p className="[word-break:break-word] bg-clip-text font-['Etihad_Altis:Text',sans-serif] leading-[16px] not-italic relative shrink-0 text-[12px] text-[transparent] tracking-[-0.1px] whitespace-nowrap" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 93 16\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(2.3495 -1.9327e-13 6.0335e-13 6.1525 36.711 8)\\'><stop stop-color=\\'rgba(142,142,147,0.35)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(142,142,147,1)\\' offset=\\'1\\'/></radialGradient></defs></svg>')" }}>
        Thinking deeply...
      </p>
    </div>
  );
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Frame">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="tag">
        <div className="absolute inset-[5.95%_7.6%_6.08%_7.52%]" data-name="Icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.5807 14.0755">
            <path clipRule="evenodd" d={svgPaths.pf910580} fill="var(--fill-0, #C3C3C5)" fillRule="evenodd" id="Icon" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#8e8e93] text-[12px] tracking-[-0.1px] whitespace-nowrap">@ Reviewing live aviation APIs</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex h-[14px] items-center justify-center left-0 overflow-clip px-[7px] top-[16px] w-[16px]" data-name="Frame">
      <div className="h-[9px] relative shrink-0 w-px" data-name="Divider">
        <div className="absolute bg-[#ededed] inset-0" data-name="Divider" />
      </div>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex h-[14px] items-center justify-center left-0 overflow-clip px-[7px] top-[37px] w-[16px]" data-name="Frame">
      <div className="h-[9px] relative shrink-0 w-px" data-name="Divider">
        <div className="absolute bg-[#ededed] inset-0" data-name="Divider" />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="tag">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="tag">
          <circle cx="8" cy="8" fill="var(--fill-0, #C3C3C5)" id="Ellipse" r="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Frame">
      <Tag />
      <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#8e8e93] text-[12px] tracking-[-0.1px] whitespace-nowrap">Checking airline and airport databases...</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col font-['Etihad_Altis:Text',sans-serif] gap-[8px] items-start justify-center min-w-px not-italic relative text-[12px] tracking-[-0.1px]" data-name="Frame">
      <p className="leading-[16px] relative shrink-0 text-[#8e8e93] whitespace-nowrap">Analyzing delay and gate-change updates...</p>
      <div className="leading-[0] min-w-full relative shrink-0 text-[#c3c3c5] w-[min-content] whitespace-pre-wrap">
        <p className="leading-[17px] mb-0">Flight EY63 has been identified as an Etihad Airways route operating between Abu Dhabi and London. To provide accurate status information, I need to determine the exact travel date, as departure times, aircraft assignments, and operational updates may vary between flights.</p>
        <p className="leading-[17px] mb-0">​</p>
        <p className="leading-[17px]">{`I'm now retrieving the available flight instances and checking schedule consistency across upcoming departures. Once a date is selected, I'll verify live status data, including departure and arrival times, terminal information, delays, gate assignments, and aircraft details.`}</p>
      </div>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex items-center relative shrink-0" data-name="Etihad LOGO">
        <Frame9 />
      </div>
      <Frame />
    </div>
...
function Response() {
  return (
    <div className="content-stretch flex flex-col items-start py-[12px] relative shrink-0 w-full" data-name="Response">
      <Frame12 />
    </div>
  );
}
...
function IconPlusLarge() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="IconPlusLarge">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="IconPlusLarge">
          <path d={svgPaths.p1d6d3500} id="Vector" stroke="var(--stroke-0, #1D1C1B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function ButtonIcon() {
  return (
    <div className="bg-[#ebebea] content-stretch flex items-center justify-center p-[10px] relative rounded-[99px] shrink-0 size-[40px]" data-name="Button_Icon">
      <IconPlusLarge />
    </div>
  );
}
...
function ButtonIcon1() {
  return (
    <div className="content-stretch flex items-center justify-center p-[10px] relative rounded-[99px] shrink-0 size-[40px]" data-name="Button_Icon">
      <IconMicrophone />
    </div>
  );
}
...
function ButtonIcon2() {
  return (
    <div className="bg-[#1d1c1b] content-stretch flex items-center justify-center p-[10px] relative rounded-[99px] shrink-0 size-[40px]" data-name="Button_Icon">
      <IconVoiceHigh />
    </div>
  );
}
...
function InputBox() {
  return (
    <div className="bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.05)] relative rounded-[24px] shrink-0 w-full" data-name="Input box">
...
function Background() {
  return (
    <div className="bg-[#f8f7f7] flex-[1_0_0] min-h-px relative w-full" data-name="Background">
...
export default function Aside() {
  return (
    <div className="bg-[#f6f8f9] content-stretch drop-shadow-[-18px_0px_18px_rgba(17,24,39,0.08)] flex flex-col items-start pl-px relative size-full" data-name="Aside">

import svgPaths from "./svg-zgq7owpgln";
import { imgGroup, imgGroup1, imgGroup2, imgGroup3 } from "./svg-9hr41";
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-[393px]">
...
function Button() {
  return (
    <div className="bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.05)] relative rounded-[72px] shrink-0 w-full" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[16px] relative size-full">
          <IconAirplane />
          <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#1d1c1b] text-[15px] whitespace-nowrap">Help me find and book the best flight for my trip</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.05)] relative rounded-[72px] shrink-0 w-full" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[16px] relative size-full">
          <IconTimeslot />
          <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#1d1c1b] text-[15px] whitespace-nowrap">Check the current status of my flight</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.05)] relative rounded-[72px] shrink-0 w-full" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[16px] relative size-full">
          <IconParasol />
          <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#1d1c1b] text-[15px] whitespace-nowrap">Help me discover new places</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.05)] relative rounded-[72px] shrink-0 w-full" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[16px] relative size-full">
          <IconBag />
          <p className="[word-break:break-word] font-['Etihad_Altis:Text',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#1d1c1b] text-[15px] whitespace-nowrap">What baggage can I bring on my trip?</p>
        </div>
      </div>
    </div>
  );
...
function Labels() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="Labels">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function Message() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full z-[1]" data-name="Message">
      <Frame1 />
      <Frame3 />
    </div>
  );
...
function Container1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col isolate items-center justify-center min-h-px relative w-full" data-name="Container">
      <Message />
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start max-w-[672px] min-h-px relative w-full" data-name="Container">
      <Container1 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Header">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[12px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Etihad_Altis:Text',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#1d1c1b] text-[15px]">Hey! I want to check a flight status EY63</p>
        </div>
      </div>
    </div>
  );
